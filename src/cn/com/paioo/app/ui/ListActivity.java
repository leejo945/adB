...
//import cn.com.paioo.app.view.stub.CacheActivity;
...
//	// };
//
////	private String[] mHeaderNames = { "a", "b", "c", "d", "e", "f", "h", "i" };
...
//			sections.add(new Section(mHeaderPositions[i], "A"+i));
//		}
//		SimpleSectionedListAdapter simpleSectionedGridAdapter = new SimpleSectionedListAdapter(
//				this, R.layout.list_item_header, mAdapter);
